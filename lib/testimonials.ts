...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    roleHi: "हॉस्पिटल एडमिनिस्ट्रेटर",
  ...
  },
  {
    ...
    location: "Lucknow, UP",
    locationHi: "लखनऊ, यूपी",
    rating: 5,
    quote:
      "The dish wash liquid cuts through the heaviest cooking grease in our kitchen. We use it in bulk daily and the results are always excellent. Our utensils shine.",
    quoteHi:
      "डिश वॉश लिक्विड हमारी रसोई की सबसे ज़िद्दी चिकनाई भी आसानी से काट देता है। हम इसे रोज़ाना बल्क में इस्तेमाल करते हैं और नतीजे हमेशा शानदार रहते हैं। हमारे बर्तन चमक उठते हैं।",
  },
  {
    name: "Vikram Singh",
    role: "Facility Manager",
    roleHi: "फैसिलिटी मैनेजर",
    location: "Kanpur, UP",
    locationHi: "कानपुर, यूपी",
    rating: 5,
    quote:
      "Managing a large office complex means constant cleaning. The multi-purpose cleaner saves us time and money — one product for almost every surface. Fantastic quality.",
    quoteHi:
      "एक बड़े ऑफिस कॉम्प्लेक्स को संभालने का मतलब है लगातार सफ़ाई। मल्टी-पर्पज़ क्लीनर हमारा समय और पैसा दोनों बचाता है — लगभग हर सतह के लिए एक ही प्रोडक्ट। शानदार क्वालिटी।",
  },
  {
    name: "Priya Sharma",
    role: "Working Mother",
  ...
  {
    name: "Mohd. Arif",
    role: "Hotel Housekeeping Head",
    roleHi: "होटल हाउसकीपिंग हेड",
    location: "Ayodhya, UP",
  ...
  },
  {
    ...
    locationHi: "गाज़ीपुर, यूपी",
    rating: 5,
    quote:
      "From the toilet cleaner to the room freshener, everything works beautifully. My home smells fresh and looks clean without me spending hours scrubbing.",
    quoteHi:
      "टॉयलेट क्लीनर से लेकर रूम फ्रेशनर तक, हर चीज़ बेहतरीन काम करती है। मेरा घर ताज़ा महकता है और साफ़ दिखता है, वो भी घंटों रगड़ाई किए बिना।",
  },
  {
    name: "Ravi Prakash",
    role: "Cleaning Agency Owner",
    roleHi: "क्लीनिंग एजेंसी मालिक",
