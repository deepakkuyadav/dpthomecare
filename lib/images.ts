...
export const IMG = {
  ...
  cleaningProductsTable: "/brand/products-lineup-v4.jpg", // DPT-branded product lineup (v2)
  ...
  warehousePallet: "/brand/warehouse-pallet-v4.jpg", // DPT-branded packed stock (v2)
} as const;
