...
export const faqGroups: FaqGroup[] = [
  {
    ...
    items: [
      ...
      { question: "What is the shelf life of your products?", questionHi: "आपके प्रोडक्ट्स की शेल्फ लाइफ कितनी है?", answer: "Most DP Shudh Dhulai products have a shelf life of 24 months from the date of manufacture when stored in a cool, dry place away from direct sunlight.", answerHi: "ठंडी, सूखी जगह पर और सीधी धूप से दूर रखने पर ज़्यादातर DP Shudh Dhulai प्रोडक्ट्स की शेल्फ लाइफ निर्माण की तारीख से 24 महीने होती है।" },
  ...
  },
  {
    ...
    items: [
      { question: "How can I become a DP Shudh Dhulai distributor?", questionHi: "मैं DP Shudh Dhulai डिस्ट्रीब्यूटर कैसे बन सकता हूँ?", answer: "Visit our Become a Distributor page and fill out the dealer enquiry form. Our team will review your application and get in touch to discuss the opportunity.", answerHi: "हमारे 'डिस्ट्रीब्यूटर बनें' पेज पर जाएँ और डीलर इन्क्वायरी फ़ॉर्म भरें। हमारी टीम आपका आवेदन देखेगी और इस अवसर पर बात करने के लिए आपसे संपर्क करेगी।" },
  ...
  },
  {
    ...
    items: [
      { question: "Where is DP Shudh Dhulai Home Care located?", questionHi: "DP Shudh Dhulai होम केयर कहाँ स्थित है?", answer: "We are based at Ambedkar Tiraha, Jaunpur, Uttar Pradesh 222002, India.", answerHi: "हम अंबेडकर तिराहा, जौनपुर, उत्तर प्रदेश 222002, भारत में स्थित हैं।" },
